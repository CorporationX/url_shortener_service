...
public class HashRepositoryTest {
    ...
    public void setUp() {
        ...
        jdbcTemplate.execute("CREATE TABLE hash (hash VARCHAR(255) PRIMARY KEY)");

        jdbcTemplate.execute("CREATE SEQUENCE IF NOT EXISTS unique_number_seq");

        jdbcTemplate.execute("INSERT INTO hash (hash) VALUES ('hash1')");
        jdbcTemplate.execute("INSERT INTO hash (hash) VALUES ('hash2')");
        jdbcTemplate.execute("INSERT INTO hash (hash) VALUES ('hash3')");
    }
