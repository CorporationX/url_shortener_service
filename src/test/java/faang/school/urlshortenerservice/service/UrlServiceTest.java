...
class UrlServiceTest {
    ...
    void testGetShortenedUrl_DuplicateKey() {
        ...
        when(urlRepository.getHashByUrl("https://example.com")).thenReturn("abc123");
    ...
    void testGetLongUrlByHash_CachedUrl() {
        ...
        verify(urlRepository, never()).getLongUrlByHash(anyString());
    }
    ...
    void testGetLongUrlByHash_NotCachedButExistsInDB() {
        ...
        verify(urlRepository, times(1)).getLongUrlByHash(hash);
    }
