...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(UrlDataValidationException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse handleUrlDataValidationException(DataValidationException e) {
        log.info("Url not found", e);
