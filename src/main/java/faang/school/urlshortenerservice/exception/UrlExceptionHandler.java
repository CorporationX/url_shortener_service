...
public class UrlExceptionHandler {
    ...
    @ExceptionHandler(ExtractionCacheException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ErrorResponse handleExtractionCacheException(ExtractionCacheException e) {
        log.error("Error while extract cache: ", e);
        return new ErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR.value(), e.getMessage());
    }
