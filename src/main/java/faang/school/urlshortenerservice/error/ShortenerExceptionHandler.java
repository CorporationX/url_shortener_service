...
import faang.school.urlshortenerservice.error.hash.HashNotFoundException;
...
public class ShortenerExceptionHandler {
    ...
    private ResponseEntity<ErrorResponse> createErrorResponse(String errorMsg,
                                                              HttpStatus status,
                                                              Exception ex) {
