...
public class UrlHashCacheRedisConfiguration {
    ...
    public RedisTemplate<String, String> urlHashCacheRedisTemplate(RedisConnectionFactory connectionFactory) {
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(
        ...
        // @0 означает базу данных по умолчанию (DB 0). Если вы используете другую, измените.
