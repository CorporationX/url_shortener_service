...
Сервис отвечающий за генерацию коротких ссылок
...
* Обычная трёхслойная
  архитектура – [Controller](src/main/java/faang/school/urlshortenerservice/controller), [Service](src/main/java/faang/school/urlshortenerservice/service), [Repository](src/main/java/faang/school/urlshortenerservice/repository)
* Слой Repository реализован и на jdbcTemplate, и на JPA (Hibernate)
* Написан [GlobalExceptionHandler](src/main/java/faang/school/urlshortenerservice/controller/GlobalExceptionHandler.java)
  который умеет возвращать ошибки в формате `{"code":"CODE", "message": "message"}`
* Используется TTL кэширование вычислений
  в [CalculationTtlCacheService](src/main/java/faang/school/urlshortenerservice/service/cache/CalculationTtlCacheService.java)
* Реализован простой Messaging через [Redis pub/sub](https://redis.io/docs/manual/pubsub/)
  * [Конфигурация](src/main/java/faang/school/urlshortenerservice/config/RedisConfig.java) –
  ...
  * [Отправитель](src/main/java/faang/school/urlshortenerservice/service/messaging/RedisCalculationPublisher.java) – генерит
    рандомные запросы и отправляет в очередь
  * [Получатель](src/main/java/faang/school/urlshortenerservice/service/messaging/RedisCalculationSubscriber.java) –
    получает запросы и отправляет задачи асинхронно выполняться
    в [воркер](src/main/java/faang/school/urlshortenerservice/service/worker/CalculationWorker.java)
